...
トランプ・スートマーク・麻雀牌・ダイス・英数字・ギリシャ文字を、宝石をモチーフとした
6 バリアント（星幽 / 翠玉 / 紅玉 / 白磁 / 黒磁 / 砂金）で統一した作風で収録しています。
下図はカテゴリ別の全図柄と、各カテゴリのバリアント見本です。

![Secvier 収録内容一覧（カテゴリ別の全図柄とバリアント見本）](docs/previews/glyphset.png)
